module Vedeu
  ...
  module Bindings
    ...
    module Document
      ...
      # See {file:docs/events.md#\_editor_execute_}
      def editor_execute!
      ...
      # See {file:docs/events.md#\_editor_delete_character_}
      ...
      # See {file:docs/events.md#\_editor_delete_line_}
      ...
      # See {file:docs/events.md#\_editor_down_}
      def editor_down!
      ...
      # See {file:docs/events.md#\_editor_insert_character_}
      ...
      # See {file:docs/events.md#\_editor_insert_line_}
      ...
      # See {file:docs/events.md#\_editor_left_}
      def editor_left!
        Vedeu.bind(:_editor_left_) { |name| Vedeu.documents.by_name(name).left }
      end

      # See {file:docs/events.md#\_editor_right_}
      def editor_right!
      ...
      # See {file:docs/events.md#\_editor_up_}
      def editor_up!
