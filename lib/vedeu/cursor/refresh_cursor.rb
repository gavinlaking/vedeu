module Vedeu
  ...
  class RefreshCursor
    ...
    #
    # @note
    #   Vedeu::Border is used in this way because if there is not a border defined, it
    #   will fallback to a Vedeu::Null::Border which uses Vedeu::Geometry to determine
    #   it's dimensions based on the name also. When a Vedeu::Geometry cannot be found,
    #   this falls back to a Vedeu::Null::Geometry which uses the current terminal's
    #   dimensions.
    #
