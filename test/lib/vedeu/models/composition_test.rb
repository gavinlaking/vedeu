  ...
  describe Composition do
    ...
    describe '#to_s' do
      it 'returns the stringified content for a single interface, single line, single stream' do
        Repositories::Interface.create({ name: 'int1_lin1_str1', y: 3, x: 3, width: 10, height: 3 })
      ...
      it 'returns the stringified content for a single interface, single line, multiple streams' do
        Repositories::Interface.create({ name: 'int1_lin1_str3', y: 3, x: 3, width: 10, height: 3 })
      ...
      it 'returns the stringified content for a single interface, multiple lines, single stream' do
        Repositories::Interface.create({ name: 'int1_lin2_str1', y: 3, x: 3, width: 10, height: 3 })
      ...
      it 'returns the stringified content for a single interface, multiple lines, multiple streams' do
        Repositories::Interface.create({ name: 'int1_lin2_str3', y: 3, x: 3, width: 10, height: 3 })
      ...
      it 'returns the stringified content for a single interface, multiple lines, multiple streams, streams contain styles' do
        ...
        attributes = JSON.load(json, nil, symbolize_names: true)
        Repositories::Interface.create({ name: 'int1_lin2_str3_styles', y: 3, x: 3, width: 10, height: 3 })
      ...
      it 'returns the stringified content for multiple interfaces, single line, single stream' do
        Repositories::Interface.create({ name: 'int2_lin1_str1_1', y: 3, x: 3, width: 10, height: 3 })
        Repositories::Interface.create({ name: 'int2_lin1_str1_2', y: 6, x: 6, width: 10, height: 3 })
      ...
      it 'returns the stringified content for multiple interfaces, single line, multiple streams' do
        Repositories::Interface.create({ name: 'int2_lin1_str3_1', y: 3, x: 3, width: 10, height: 3 })
        Repositories::Interface.create({ name: 'int2_lin1_str3_2', y: 6, x: 6, width: 10, height: 3 })
      ...
      it 'returns the stringified content for multiple interfaces, multiple lines, single stream' do
        Repositories::Interface.create({ name: 'int2_lin2_str1_1', y: 3, x: 3, width: 10, height: 3 })
        Repositories::Interface.create({ name: 'int2_lin2_str1_2', y: 6, x: 6, width: 10, height: 3 })
      ...
      it 'returns the stringified content for multiple interfaces, multiple lines, multiple streams' do
        Repositories::Interface.create({ name: 'int2_lin2_str3_1', y: 3, x: 3, width: 10, height: 3 })
        Repositories::Interface.create({ name: 'int2_lin2_str3_2', y: 6, x: 6, width: 10, height: 3 })
      ...
      it 'returns the stringified content for multiple interfaces, multiple lines, multiple streams, streams contain styles' do
        Repositories::Interface.create({ name: 'int2_lin2_str3_styles_1', y: 3, x: 3, width: 10, height: 3 })
        Repositories::Interface.create({ name: 'int2_lin2_str3_styles_2', y: 6, x: 6, width: 10, height: 3 })
