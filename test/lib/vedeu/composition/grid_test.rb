        ...
        context 'when there is data and styles match' do
          context 'when we try something simple' do
            ...
            it 'returns an interpolated array' do
              subject.must_equal(
                [
                  [["\e[38;5;31m\e[48;5;40m", "a", "\e[0m"], ["\e[38;5;39m\e[48;5;40m", "b", "\e[0m"]]
                ]
              )
            end
          end
          ...
          context 'when we try something a little more complex' do
            ...
            it 'returns an interpolated array' do
              subject.must_equal(
                [
                  [["\e[38;5;31m\e[48;5;42m", "a", "\e[0m"], ["\e[38;5;39m\e[48;5;40m", "b", "\e[0m"], ["\e[38;5;32m\e[48;5;44m", "c", "\e[0m"]],
                  [["\e[38;5;34m\e[48;5;42m", "d", "\e[0m"], ["\e[38;5;33m\e[48;5;49m", "e", "\e[0m"], ["\e[38;5;35m\e[48;5;47m", "f", "\e[0m"]]
                ]
              )
            end
          end
